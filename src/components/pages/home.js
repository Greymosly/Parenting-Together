    ...
    return (
      <div className="homepage">
        ...
        <div className="homepage__text">
          ...
          allow us to manage the parenting schedule, upload pictures, documents
          and plan for big events in her life. Imogene may have two houses but
          she shares one united home in the bettering of her life.
        </div>
      </div>
    );
  }
